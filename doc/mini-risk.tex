...
The \textit{src} subdirectory also contains a \textit{Makefile} for \textit{gcc} compilation. If you use Visual Studio 2019, you can use the solution provided in the vs directory or create a new solution.
...
\item Your compilation should produce no warnings.
